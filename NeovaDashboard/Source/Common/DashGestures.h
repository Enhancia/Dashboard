...
namespace neova_dash
{
	namespace gesture
    {
        ...
        const float PITCHBEND_MIN = -80.0f;
        const float PITCHBEND_MAX =  80.0f;
        const float TILT_MIN = -80.0f;
        const float TILT_MAX =  80.0f;
        const float ROLL_MIN = -80.0f;
        const float ROLL_MAX =  80.0f;
        const float WAVE_MIN = -80.0f;
        const float WAVE_MAX =  80.0f;
